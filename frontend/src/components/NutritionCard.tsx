...
const FOODS: { name: string; serving: string; grams: number; calories: number; protein: number; carbs: number; fats: number }[] = [
  ...
  { name: "Ground Turkey 93/7", serving: "≈6 oz", grams: 170, calories: 280, protein: 44, carbs: 0, fats: 12 },
  { name: "Sirloin Steak", serving: "≈8 oz", grams: 227, calories: 460, protein: 62, carbs: 0, fats: 22 },
  { name: "Cod", serving: "≈6 oz", grams: 170, calories: 150, protein: 34, carbs: 0, fats: 1 },
  { name: "Sardines (canned)", serving: "≈1 can", grams: 92, calories: 190, protein: 23, carbs: 0, fats: 11 },
  { name: "Chicken Thigh", serving: "≈6 oz", grams: 170, calories: 340, protein: 42, carbs: 0, fats: 18 },
  { name: "Whole Egg (1 large)", serving: "≈1 large", grams: 50, calories: 70, protein: 6, carbs: 0, fats: 5 },
  { name: "String Cheese", serving: "≈1 stick", grams: 28, calories: 80, protein: 7, carbs: 1, fats: 6 },
  { name: "2% Greek Yogurt", serving: "≈1 cup", grams: 245, calories: 190, protein: 20, carbs: 12, fats: 5 },
  { name: "Casein Protein", serving: "≈1 scoop", grams: 33, calories: 120, protein: 24, carbs: 4, fats: 1 },
  { name: "Mass Gainer", serving: "≈1 scoop", grams: 165, calories: 650, protein: 32, carbs: 120, fats: 5 },
  { name: "Jasmine Rice (cooked)", serving: "≈1 cup", grams: 158, calories: 205, protein: 4, carbs: 45, fats: 0 },
  { name: "Couscous (cooked)", serving: "≈1 cup", grams: 157, calories: 175, protein: 6, carbs: 36, fats: 0 },
  { name: "Ezekiel Bread", serving: "≈2 slices", grams: 68, calories: 160, protein: 8, carbs: 30, fats: 1 },
  { name: "Cream of Rice (dry)", serving: "≈1/4 cup", grams: 45, calories: 170, protein: 3, carbs: 38, fats: 0 },
  { name: "Grapes", serving: "≈1 cup", grams: 151, calories: 104, protein: 1, carbs: 27, fats: 0 },
  { name: "Pineapple", serving: "≈1 cup", grams: 165, calories: 82, protein: 1, carbs: 22, fats: 0 },
  { name: "Mango", serving: "≈1 cup", grams: 165, calories: 99, protein: 1, carbs: 25, fats: 0 },
  { name: "Dates", serving: "≈2 dates", grams: 48, calories: 133, protein: 1, carbs: 36, fats: 0 },
  { name: "Asparagus", serving: "≈1 cup", grams: 134, calories: 27, protein: 3, carbs: 5, fats: 0 },
  { name: "Green Beans", serving: "≈1 cup", grams: 125, calories: 44, protein: 2, carbs: 10, fats: 0 },
  { name: "Carrots", serving: "≈1 cup", grams: 128, calories: 52, protein: 1, carbs: 12, fats: 0 },
  { name: "Edamame", serving: "≈1 cup", grams: 155, calories: 190, protein: 17, carbs: 15, fats: 8 },
  { name: "Tofu (firm)", serving: "≈1/2 block", grams: 126, calories: 180, protein: 20, carbs: 4, fats: 11 },
  { name: "Almond Butter", serving: "≈2 tbsp", grams: 32, calories: 200, protein: 7, carbs: 6, fats: 18 },
  { name: "Coconut Oil", serving: "≈1 tbsp", grams: 14, calories: 120, protein: 0, carbs: 0, fats: 14 },
  { name: "Honey", serving: "≈1 tbsp", grams: 21, calories: 64, protein: 0, carbs: 17, fats: 0 },
  { name: "Granola", serving: "≈1/2 cup", grams: 61, calories: 280, protein: 6, carbs: 38, fats: 12 },
];
