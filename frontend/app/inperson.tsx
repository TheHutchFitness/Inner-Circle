...
const styles = StyleSheet.create({
  ...
  composer: { flexDirection: "row", alignItems: "center", gap: 2, backgroundColor: colors.surface2, borderRadius: radius.pill, borderWidth: 1, borderColor: colors.border, paddingHorizontal: 6, paddingVertical: 4 },
  ...
  iconText: { fontSize: 16, lineHeight: 20, textAlign: "center", textAlignVertical: "center", includeFontPadding: false },
  input: { flex: 1, minHeight: 30, maxHeight: 100, color: colors.text, paddingHorizontal: 6, paddingTop: 5, paddingBottom: 5, fontSize: 15, lineHeight: 20, textAlignVertical: "center", includeFontPadding: false },
  ...
  sendArrow: { color: "#04121a", fontSize: 15, lineHeight: 18, fontWeight: "900", textAlign: "center", textAlignVertical: "center", includeFontPadding: false },
