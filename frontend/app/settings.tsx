  ...
  return (
    <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : undefined} style={{ flex: 1, backgroundColor: colors.surface }}>
      <ScrollView contentContainerStyle={{ paddingTop: insets.top + spacing.md, padding: spacing.lg, paddingBottom: 40 }}>
        ...
        <NavButton testID="replay-whatsnew" onPress={async () => { await AsyncStorage.removeItem("thecircle_whatsnew_v5"); router.replace("/(tabs)"); }} icon="✨" label="WHAT'S NEW & FEATURES" tone="gold" style={{ marginTop: spacing.sm }} />
